...
int main(int argc, char* argv[]){
 ...
 string channels[ny]={"H#rightarrow#mu#tau", "#mu#tau_{e}, VBF","#mu#tau_{e}, 2 Jets","#mu#tau_{e}, 1 Jet", "#mu#tau_{e}, 0 Jets","#mu#tau_{had}, VBF","#mu#tau_{had}, 2 Jets","#mu#tau_{had}, 1 Jet", "#mu#tau_{had}, 0 Jets"}; 
 ...
 entry=leg->AddEntry("NULL","#pm 1 std deviation","f");
 entry->SetFillColor(kGreen);
 entry->SetFillStyle(1001);
 entry->SetLineStyle(1);
 entry=leg->AddEntry("NULL","#pm 2 std deviation","f");
