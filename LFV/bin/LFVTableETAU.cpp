...
int main(int argc, char* argv[]){
 ...
 string flavour[3]={"mue","etau","comb"};
 string flavourlatex[3]={"$\\textrm{e}\\tau_{\\mu}$" ,"$\\textrm{e}\\tau_{h}$","$\\textrm{e}\\tau$"};

 string appendix[5]={"0JET","1JET","21JET","22JET","COMBINED"};
 printf("Extended Table with uncertainties \n");
 printf("================================= \n");
 printf("Channel -2s -1s Median +1s +2s Observed Significance \n");
 printf("================================= \n");
 ...
 for (int j=0; j<3; j++){
  ...
  for (int i=0; i<5; i++){
   ...
   TTree* limitTreeSig=(TTree*)inputSig.Get("limit"); limitTreeSig->SetName("limitTreeSig");
   Double_t sig; 
   ...
   for (Long64_t k=0;k<nentries;k++) { printf("\t %2.2f",limitForCout[k]);}
   printf("\t %2.2f",sig);
   printf("\n");
 ...
 for (int j=0; j<3; j++){
  ...
  printf("\\cline{2-6}  \n $\\textrm{e}\\tau$  & \\multicolumn{5}{c}{ $<$ %2.2f  } \\\\ \\hline ", MEDIAN[2][4]);
 ...
 for (int j=0; j<3; j++){
  ...
  printf("\\cline{2-6} \n  $\\textrm{e}\\tau$  & \\multicolumn{5}{c}{ $<$ %2.2f  } \\\\ \\hline ", OBSERVED[2][4]);
 ...
 for (int j=0; j<3; j++){
  ...
  printf("\\cline{2-6} \n $\\textrm{e}\\tau$  & \\multicolumn{5}{c}{ %2.2f  } \\\\ \\hline ", SIGNIFICANCE[2][4]);
...
*/
 ...
 for (int j=0; j<3; j++){
  ...
  printf("\\\\  \n");
   ...
   printf("\\cline{2-6} \n $\\textrm{e}\\tau$  & \\multicolumn{5}{c}{ %2.2f $\\pm$ %2.2f } \\\\ \\hline ", MU[2][4],MUERR[2][4]); 
...
*/
 ...
 string channels[ny]={"H#rightarrow e#tau", " e#tau_{#mu}, VBF"," e#tau_{#mu}, 2 Jets"," e#tau_{#mu}, 1 Jet", " e#tau_{#mu}, 0 Jets"," e#tau_{h}, VBF"," e#tau_{h}, 2 Jets"," e#tau_{h}, 1 Jet", " e#tau_{h}, 0 Jets"}; 
...
/*
 ...
 latex.SetTextSize(0.04*0.76*0.80);
 latex.DrawLatex(0.36,0.96,"Preliminary");
*/

 string inputFile=folder+"/HETAU_"+folder+"_SUMMARY.pdf";
 ...
 h2->SetXTitle("Best Fit to #bf{#it{#Beta}}(H#rightarrow e#tau), %");
...
/* latex2.SetTextAlign(11); // align left
 ...
 latex2.SetTextSize(0.04*0.76*0.80);
 latex2.DrawLatex(0.36,0.96,"Preliminary");
*/

 string inputFile2=folder+"/HETAU_"+folder+"_BESTFIT.pdf";
